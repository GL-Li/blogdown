...
## Interactive mapping of population change of US cities
Zoom and click to find out the population data of cities in 2017 and changes in 5 years. Next section we show how to make this map.
...
Surprisingly, Texas has most cities in both top 10 lists, 3 in top 10 doomed cities and 4 in top 10 boomed cities. The tables below give city names, population in 2012 and 2017, and the population change (%) 

#### The doomed: top 10 cities with the most population loss

```{r}
popul[1:10, .(NAME, p2012 = p1,  p2017 = p2, "change(%)" = change)]
```

#### The boomed: top 10 cities with the most population gain
```{r}
popul[(.N-9):.N, .(NAME, p2012 = p1,  p2017 = p2, "change(%)" = change)]
```
...
And here is the interactive mapping using `leaflet`. Zoom in and click to get more details.
```{r eval=FALSE}
pal <- colorFactor(
    palette = c("blue", "green", "cyan", "orange", "magenta"),
    domain = popul$group
