---
title: Using totalcensus package to determine relationship between census geographic entities
author: GL Li
date: '2017-12-28'
...
This is an application example of [totalcensus](https://github.com/GL-Li/totalcensus) package.
...
It is easy to get the summary statistics of lower geographies within a higher one when they are connected. If we want the race population of all county subdivision in Kent county, RI, we can run
