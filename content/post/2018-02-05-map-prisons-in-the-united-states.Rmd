...
We use [`totalcensus` package](https://github.com/GL-Li/totalcensus) to extract prison data at county subdivision level and use `leaflet` package to make interactive map. Zoom in and click on each data point to find more information about a prison. 
